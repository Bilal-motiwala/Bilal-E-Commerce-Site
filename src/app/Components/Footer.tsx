...
const Footer = () => {
  return (
    <div>
      <div className='bg-black w-full h-auto pt-12'>
        <div className='w-full sm:w-[100%] lg:w-[1170px] flex flex-col sm:gap-8 lg:flex-row lg:justify-around h-auto mt-[80px] mx-auto'>
          {/* Subscribe Section */}
          <div className='w-full sm:w-[100%] lg:w-[217px] h-auto flex flex-col gap-4'>
            ...
            <input type="text" placeholder='Enter your email' className='bg-black w-full sm:w-[217px] h-[48px] rounded border-[1.5px] text-white pl-[16px]' />
          </div>

          {/* Support Section */}
          <div className='w-full sm:w-[100%] lg:w-[175px] h-auto flex flex-col gap-4'>
          ...
          {/* Account Section */}
          <div className='w-full sm:w-[100%] lg:w-[123px] h-auto flex flex-col gap-4'>
          ...
          {/* Quick Links Section */}
          <div className='w-full sm:w-[100%] lg:w-[109px] h-auto flex flex-col gap-4'>
          ...
          <div className='w-full sm:w-[100%] lg:w-[198px] h-auto flex flex-col gap-4'>
            ...
            <Image src="/Qrcode.png" alt="QR Code" height={84} width={140} className='mt-3' />
            <Image src="/Fbicons.png" alt="Facebook Icon" height={24} width={168} className='mt-2' />
          </div>
        </div>

        {/* Divider */}
        <div className='w-full bg-[#FAFAFA] opacity-[40%] h-[1px] mt-[40px]'></div>
